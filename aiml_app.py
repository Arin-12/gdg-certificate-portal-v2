...
<div class="header-title">🚀 THE INTELLIGENCE MINDSET</div>
<div class="header-subtitle">Hands-on AI/ML & Data Science Workshop</div>
<div class="badge">📅 18th March | GDG On Campus MIT-A</div>
...
def generate_certificate(name):
    ...
    # Background
    c.drawImage("AIML.png", 0, 0, width=842, height=595)
